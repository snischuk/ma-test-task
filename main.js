...
;// CONCATENATED MODULE: ./src/scripts/ui/Card/card.js

function createCard(card) {
  var CARD_ELEMENT = document.createElement('article');
  ...
  TITLE_ELEMENT.textContent = "".concat(card.title);
  var DESCRIPTION_ELEMENT = document.createElement('p');
  DESCRIPTION_ELEMENT.classList.add('card__description');
  DESCRIPTION_ELEMENT.textContent = "".concat(card.description);
  var TAG_ELEMENT = document.createElement('span');
  TAG_ELEMENT.classList.add('card__tag');
  TAG_ELEMENT.textContent = "".concat(card.category.name);
  var FOOTER_ELEMENT = document.createElement('span');
  ...
  var PRICE_TEXT_ELEMENT = document.createElement('span');
  PRICE_TEXT_ELEMENT.classList.add('card__price-text');
  PRICE_TEXT_ELEMENT.textContent = 'Price';
  var PRICE_VALUE_ELEMENT = document.createElement('span');
  PRICE_VALUE_ELEMENT.classList.add('card__price-value');
  PRICE_VALUE_ELEMENT.textContent = "$".concat(card.price);
...
;// CONCATENATED MODULE: ./src/scripts/ui/Cards/cards.js


function createCards(cards) {
  var CARDS_ELEMENT = document.createElement('div');
  CARDS_ELEMENT.classList.add('cards');
  cards.map(function (card) {
    var CARD_ELEMENT = createCard(card);
    CARDS_ELEMENT.append(CARD_ELEMENT);
  });
  return CARDS_ELEMENT;
}

;// CONCATENATED MODULE: ./src/scripts/api/fetch-cards.js
...
function _fetchCards() {
  _fetchCards = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var cardsURL, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          cardsURL = 'https://api.escuelajs.co/api/v1/products';
          _context.prev = 1;
          _context.next = 4;
        ...
        case 10:
          ...
          console.error("GET error: ".concat(_context.t0));
...
;// CONCATENATED MODULE: ./src/scripts/ui/Loader/loader.js

function loader() {
  var LOADER_ELEMENT = document.createElement('div');
  LOADER_ELEMENT.classList.add('loader');
  var LOADER_TEXT_ELEMENT = document.createElement('p');
  LOADER_TEXT_ELEMENT.classList.add('loader__text');
  LOADER_TEXT_ELEMENT.textContent = 'Loading...';
  var LOADER_SPINNER_ELEMENT = document.createElement('p');
...
;// CONCATENATED MODULE: ./src/scripts/ui/FetchError/fetch-error.js

function showFetchError() {
  var FETCH_ERROR_ELEMENT = document.createElement('p');
...
function _render() {
  _render = src_asyncToGenerator( /*#__PURE__*/src_regeneratorRuntime().mark(function _callee() {
    var LOADER_ELEMENT, response, fetchedCards, CARDS_ELEMENT, FETCH_ERROR_ELEMENT;
    return src_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          fetchedCards = _context.sent;
          if (fetchedCards) {
            LOADER_ELEMENT.remove();
            CARDS_ELEMENT = createCards(fetchedCards);
            CARDS_ELEMENT.classList.add('cards');
        ...
        case 12:
          ...
          FETCH_ERROR_ELEMENT = showFetchError();
